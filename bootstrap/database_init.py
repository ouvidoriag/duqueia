...
def init_db(db_path, schema_file, indexes_file=None, db_name=""):
    """Inicializa uma base SQLite ativando WAL mode, pragmas otimizados e executando DDLs de schema e índices."""
...
def setup_database():
    """Garante que as 4 bases SQLite do sistema (main, vector, cache, telemetry) estejam inicializadas e semeadas."""
